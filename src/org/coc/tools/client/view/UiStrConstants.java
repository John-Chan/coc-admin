...
public class UiStrConstants {
	public static class ValueNames{
		...
		public	static final String CLAN_SYMBOL="Clan Symbol";

		public	static final String HOME_CLAN="Home Clan";
		public	static final String HOME_CLAN_NAME="Home Clan Name";
		public	static final String HOME_CLAN_TAG="Home lan Tag";
		public	static final String HOME_CLAN_SYMBOL="Home Clan Symbol";

		public	static final String ENEMY_CLAN="Enemy Clan";
		public	static final String ENEMY_CLAN_NAME="Enemy Clan Name";
		public	static final String ENEMY_CLAN_TAG="Enemy Clan Tag";
		public	static final String ENEMY_CLAN_SYMBOL="Enemy Clan Symbol";
		

		public	static final String WAR_INDEX_ID="War ID";
		public	static final String WAR_PREPARE_DATE="Prepare Day";
