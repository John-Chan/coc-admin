...
public class ObjectifyDao<EntityType extends ObjectifyEntity> {
	...
	public static <E extends ObjectifyEntity> Key<E> getKey(Class<E> clazz,Long id) {
	   return Key.create(clazz, id);
	}

	/// never return null
	public static <E extends ObjectifyEntity> List<Key<E>> getKeyList(Class<E> clazz,List<E> list) {
	...
	public static <E extends ObjectifyEntity> Ref<E> getRef(Class<E> clazz,Long id) {
		   return Ref.create(ObjectifyDao.getKey(clazz, id));
	}
	/// never return null
	public static <E extends ObjectifyEntity> List<Ref<E>> getRefList(Class<E> clazz,List<E> list) {
		List<Ref<E>> refs= new ArrayList<Ref<E>>();
		for(E val:list){
			//Ref<E> ref=Ref.create(ObjectifyDao.getKey(clazz, val.getRowId()));
	...
	public Map<Key<EntityType>,EntityType> save(
